...
function loadAbout(){
	...
	var text = "Now working at Kla-Tencor Rapid Software Team, Focus on the developing and improving new features for our latest real-time Inspection Equipment(Rapid Series, 5XX and 6XX), including the FA(Factory Automation) realization and relevant features."+"<br /><br />"
				+"I am a student from department of Automation, <a href=http://www.seu.edu.cn/s/132/>Southeast University,China </a> and now continue my studies in the field of Computer Science at <a href= http://www.telecom-paristech.fr/nc/formation-et-innovation-dans-le-numerique.html>ENST</a>, Paris, France. I am interested about all new technologies in the filed of computer science. " + "<br /><br />" 
				+"After six months of experiences as an intern at <a href=https://maps.google.fr/maps?safe=off&q=IBM+France+lab,+Gentilly&bav=on.2,or.r_cp.r_qf.&bvm=bv.45921128,d.d2k&biw=1366&bih=653&um=1&ie=UTF-8&hl=fr&sa=N&tab=wl&authuser=0>IBM France lab, Gentilly</a>, I am deeply impressed by its value and unique culture. I look forward to have the chance to start my career in such an enterprise. It gives my passion to the new technology; I learned a lot of knowledge from the six-month internship." +"<br /><br />" 
				+"Having a basic and solid base of knowledge about Java++,C in the field of User Interface, Android application development, DataBase and a basic knowledge about the graphical 3D , I look forward to continue my carrier in these corresponding fields.<br /><br /><br />" ;
	
	var download_cv = "Note* : For more details about me, you can download my <a href='file/CV_Junxian_Xu_Eng.pdf'> CV. </a> <br />"
	var email_contact = " Email :<b> nicolas.xu89@gmail.com  or   nicolas.xu@kla-tencor.com</b> "
	var linked_in = " Linkedin :<b> <a href='https://www.linkedin.com/pub/junxian-xu/57/702/585?trk=pub-pbmap'> Junxian Xu </a> </b> "
	
	itemtext.innerHTML =text + download_cv + email_contact + linked_in;
}
...
Specialty: Automation and computer science, graduate - with honors asdfadfadfa
...
*/
	...
	var text = 
	img + "Oct/2014" + "<br/>"
	+ "<b>Rookie Award @Kla-Tencor<b/>" + "<a href=file/Rookie_award.pdf>(Rookie_Award_Cert)</a>" + "<br /><br />"
	+img + "July/2011" +"<br/>" 
